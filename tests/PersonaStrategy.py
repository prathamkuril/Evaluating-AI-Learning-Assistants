...
class PersonaStrategy(ABC):
    @abstractmethod
    def generate_questions(self, client, config: ApiConfiguration, num_questions: int, logger: logging.Logger) -> List[str]:
        """
    ...
    def _generate_questions(self, client, config: ApiConfiguration, prompt: str, num_questions: int, logger: logging.Logger) -> List[str]:
        """
